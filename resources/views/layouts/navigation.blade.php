        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    ...
                    <a href="{{ route('admin.index') }}" class=" text-indigo-500 hover:text-gray-500 px-3 py-2 rounded-md text-2xl font-medium">Admin</a>
                    @else
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('admin.jurusan.index')" :active="request()->routeIs('admin.jurusan.index')">
                        {{ __('Jurusan') }}
                    </x-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
